...
function check(){
  ...
  if (screennum==1){
    ...
    if ((lastscreennum!=1 || lastu2) && !u2){
      document.getElementById("u2").innerHTML="<button onclick='if (infinitypoints>=1){u2=1;infinitypoints-=1;u2l=setInterval(autometa,1000);}'>Get metapoint autoclicker, 1 IP</button><br>";
    ...
    if ((lastscreennum!=1 || lastu3) && !u3){
      document.getElementById("u3").innerHTML="<button onclick='if (infinitypoints>=1){u3=1;infinitypoints-=1;u3l=setInterval(autometameta,5000);}'>Get metametapoint autoclicker, 1 IP</button><br>";
    ...
    if ((lastscreennum!=1 || lastu4) && !u4){
      document.getElementById("u4").innerHTML="<button onclick='if (infinitypoints>=1){u4=1;infinitypoints-=1;u4l=setInterval(autoIP,10000);}'>Get Infinity autoclicker, 1 IP</button><br>";
